...
🎥 **Project Video:**  
[Watch the explanation video](https://drive.google.com/drive/folders/1cWC8_G2K1O8I5F3kcUSsveSenw5kVH7L?usp=sharing)
...
a naive (brute force) solution and an optimized solution based on **Kadane’s Algorithm**.
...
📄 **Naive Solution Explanation (PDF):**  
[Open Naive Solution File](naive%20solution.pdf)

📄 **Naive Solution Code (JavaScript):**  
...
📄 **Optimized Solution Explanation (PDF):**  
[Open Optimized Solution File](algo_pro_optimized.pdf)

📄 **Optimized Solution Code (JavaScript):**  
...
- `index.html` — Project live interface
- `style.css` — Styling file
- `script.js` — Script file
- `students.me` — Team information
...
The optimized solution using Kadane’s Algorithm significantly outperforms the naive approach both theoretically and empirically.

---

✨ *All files, code implementations, analysis documents, and project resources are included in this repository.*
